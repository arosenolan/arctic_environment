"""
Django settings for tools_of_curiosity_app project.
...
ROOT_URLCONF = 'tools_of_curiosity_app.urls'
...
WSGI_APPLICATION = 'tools_of_curiosity_app.wsgi.application'
